...
namespace Newcgq.Controllers
{
    public class AdminController :AdminBase
    {
        ...
        public async Task<IActionResult> Edit(string id)
        {
            ...
            var userInfo = await _context.UserInfo.SingleOrDefaultAsync(m => m.UserName == id);
            if (userInfo == null)
            {
                return NotFound();
            }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("Id,UserName,PassWord,Address,Tel,Coporation,Department,Sex")] UserInfo userInfo)
        {
